    ...
    <div id="contact" className="contact">
      ...
      <div className="contact-main fw-bolder d-flex flex-column align-items-center">
        ...
        <div className="contact-body h-75 fs-4 text-light rounded-5 text-center">
          ...
          <div className="contact-tab d-flex flex-column justify-content-center mt-0 align-items-center gap-3 fs-1 header">
            <div
              className={
                mail
                  ? "clicked bg-success"
            ...
            >
              <GrMailOption />
              <p className="fs-3 mx-3 text-dark mb-0">
                vacationcenter@holiday.mail.com
              </p>
            </div>
            <div
